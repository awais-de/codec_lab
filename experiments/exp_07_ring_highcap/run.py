"""EXP-07 -- high-capacity neural codec on the ring source. Tracks issue #6."""
...
REF_LOWCAP_GAIN_DB = 3.75
REF_LOWCAP_PARTICIPATION_RATIO = 1.997
...
def main() -> None:
    ...
    print(
        f"reference: classical {REF_CLASSICAL_GAIN_DB:+.3f} dB, "
        f"low-cap (h=4) {REF_LOWCAP_GAIN_DB:+.3f} dB / PR {REF_LOWCAP_PARTICIPATION_RATIO:.3f}\n"
    )
    print(
